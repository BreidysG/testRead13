    ...
    const questions = [
        {
            ...
            answers: [
                "Mamá y yo", 
                "Caja de cartón", 
                "Mi casa, una caja de cartón", 
                "La caja de cartón y yo"
            ], 
            correctAnswer: "Caja de cartón"
        },
        {
            question: "¿Cuál es la idea principal de la lectura?", 
            answers: [
                "La historia de una niña y su mamá inmigrantes que llegan a un nuevo país, y después de muchas situaciones, ella es adoptada por una familia que la quiere", 
                "La historia de una familia pobre que vivía en una caja de cartón", 
                "El relato de un náufrago y sus anécdotas", 
                "Todas las respuestas son correctas"
            ], 
            correctAnswer: "La historia de una niña y su mamá inmigrantes que llegan a un nuevo país, y después de muchas situaciones, ella es adoptada por una familia que la quiere"
        },
        {
            question: "¿Cuál fue la primera casa que conoció la niña?", 
            answers: [
                "El orfanato", 
                "Una embarcación", 
                "La caja de cartón", 
            ...
            correctAnswer: "La caja de cartón"
        },
        {
            question: "¿Cuándo la embarcación cayó a pique a qué lugar llegaron la niña y su mamá?", 
            answers: [
                "A un puerto seguro", 
                "Las recogió una embarcación más grande", 
                "A una playa solitaria", 
                "A un acuario"
            ], 
            correctAnswer: "A una playa solitaria"
        },
        {
            question: "¿Qué pasó finalmente con la niña?", 
            answers: [
                "Fue adoptada por una familia que la quería mucho en un nuevo país", 
                "Su mamá falleció y quedó sola en un orfanato", 
                "La niña y su mamá fueron enviadas nuevamente a su país de origen", 
                "Todas las respuestas son correctas"
            ], 
            correctAnswer: "Fue adoptada por una familia que la quería mucho en un nuevo país"
        }
    ];
